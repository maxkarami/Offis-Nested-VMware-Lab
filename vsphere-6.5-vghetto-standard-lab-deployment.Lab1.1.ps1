...
$NestedESXiHostnameToIPs = @{
    "lab1-vesxi65-1" = "172.30.1.11"
    "lab1-vesxi65-2" = "172.30.1.12"
    "lab1-vesxi65-3" = "172.30.1.13"
}
...
$VCSADisplayName = "lab1-vcenter65"
$VCSAIPAddress = "172.30.1.10"
$VCSAHostname = "172.30.1.10" #Change to IP if you don't have valid DNS
$VCSAPrefix = "16"
$VCSASSODomainName = "lab1.offis.cloud"
$VCSASSOSiteName = "lab1.offis.cloud"
...
$NewVCVSANClusterName = "offislab1"

# NSX Manager Configuration
$DeployNSX = 1
$NSXvCPU = "2" # Reconfigure NSX vCPU
$NSXvMEM = "8" # Reconfigure NSX vMEM (GB)
$NSXDisplayName = "lab1-nsx63"
$NSXHostname = "172.30.1.20"
$NSXIPAddress = "172.30.1.20"
