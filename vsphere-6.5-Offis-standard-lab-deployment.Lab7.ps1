...
$NestedESXiApplianceOVA = "D:\Source\NestedLab\Nested_ESXi6.5d_Appliance_Template_v1.0.ova"
$VCSAInstallerPath = "D:\Source\NestedLab\VMware-VCSA-all-6.5.0-5973321.iso"
$NSXOVA =  "D:\Source\NestedLab\VMware-NSX-Manager-6.3.3-6276725.ova"
$ESXi65OfflineBundle = "D:\Source\NestedLab\update-from-esxi6.5-6.5_update01\metadata.zip" # Used for offline upgrade only
$ESXiProfileName = "ESXi-6.5.0-20170404001-standard" # Used for online upgrade only

# Nested ESXi VMs to deploy
$NestedESXiHostnameToIPs = @{
    "lab7-vesxi65-1" = "172.30.7.11"
    "lab7-vesxi65-2" = "172.30.7.12"
    "lab7-vesxi65-3" = "172.30.7.13"
    "lab7-vesxi65-4" = "172.30.7.14"
}

# Nested ESXi VM Resources
$NestedESXivCPU = "2"
$NestedESXivMEM = "16" #GB
$NestedESXiCachingvDisk = "10" #GB
$NestedESXiCapacityvDisk = "100" #GB

# VCSA Deployment Configuration
$VCSADeploymentSize = "tiny"
$VCSADisplayName = "lab7-vcenter65"
$VCSAIPAddress = "172.30.7.10"
$VCSAHostname = "172.30.7.10" #Change to IP if you don't have valid DNS
$VCSAPrefix = "16"
$VCSASSODomainName = "lab7.offis.cloud"
$VCSASSOSiteName = "lab7.offis.cloud"
...
$NewVCDatacenterName = "offislab7"
$NewVCVSANClusterName = "offislab7"

# NSX Manager Configuration
$DeployNSX = 1
$NSXvCPU = "2" # Reconfigure NSX vCPU
$NSXvMEM = "8" # Reconfigure NSX vMEM (GB)
$NSXDisplayName = "lab7-nsx63"
$NSXHostname = "172.30.7.20"
$NSXIPAddress = "172.30.7.20"
...
$verboseLogFile = "vsphere65-vOffis-lab-deployment.log"
$vSphereVersion = "6.5"
$deploymentType = "Standard"
$random_string = -join ((65..90) + (97..122) | Get-Random -Count 8 | % {[char]$_})
$VAppName = "vOffis-Nested-vSphere-Lab-$vSphereVersion-$random_string"
...
if($confirmDeployment -eq 1) {
    ...
    Write-Host -ForegroundColor Yellow "---- vOffis vSphere Automated Lab Deployment Configuration ---- "
