...
$NestedESXiHostnameToIPs = @{
    "lab4-vesxi65-1" = "172.30.4.11"
    "lab4-vesxi65-2" = "172.30.4.12"
    "lab4-vesxi65-3" = "172.30.4.13"
}
...
$VCSADisplayName = "lab4-vcenter65"
$VCSAIPAddress = "172.30.4.10"
$VCSAHostname = "172.30.4.10" #Change to IP if you don't have valid DNS
$VCSAPrefix = "16"
$VCSASSODomainName = "lab4.offis.cloud"
$VCSASSOSiteName = "lab4.offis.cloud"
...
$NewVCVSANClusterName = "offislab4"

# NSX Manager Configuration
$DeployNSX = 1
$NSXvCPU = "2" # Reconfigure NSX vCPU
$NSXvMEM = "8" # Reconfigure NSX vMEM (GB)
$NSXDisplayName = "lab4-nsx63"
$NSXHostname = "172.30.4.20"
$NSXIPAddress = "172.30.4.20"
